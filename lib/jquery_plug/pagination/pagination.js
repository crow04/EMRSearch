var Pagination = (function() {
  var obj = function(el, options) {
    ...
    this.dataCount = 0
    this.unit = '条'
    this.pageSizeOptions =[10, 20, 30, 40] //[10, 20, 30, 40]
  ...
  obj.prototype = {
    ...
    _generateStyle: function() {
      var str_css = `
        ...
        .page-item.active,.page-item:hover,.page-more.active,.page-more:hover{color:#fff;background-color:#1991ff;opacity:.6008}
